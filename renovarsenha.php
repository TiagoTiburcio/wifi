        ...
        <fieldset class="container_portal">
            ...
            if ($resultado == 1) {
                if ($passo == "") {
                    ...
                    . ' <button class="botao_login" name="accept" type="submit" value="Continue">Alterar Senha</button><br /> <a type="button" class="botao"  href="cadastro.php">Cadastro</a><br /> <div/> </form>';
                } elseif ($passo == "0") {
